...
2. stop klipper: `sudo systemct stop klipper`
3. Determine the Serial id of your SKR, either by looking at printer.cfg, or via `ls /dev/serial/by-id`
4. execute the command `~/klipper/scripts/flash-sdcard.sh /dev/serial/your-serial-id-here btt-skr-mini-e3-v1.2` , replacing "your-serial-id-here" with the actual ID from the previous step
5. restart klipper: `sudo systemct start klipper`
